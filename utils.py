...
# takes a pair of images arrays, mirrors them left to right with 33% chance
# zooms adds a 0-100 pixel padding of 0's to this borders uniformly
# rotates them from -30 degrees to 30 degrees uniformly 
# and then crops the same number of pixels that were padded
